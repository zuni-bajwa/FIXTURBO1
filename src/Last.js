...
import last3 from './img/last3.png'
import last1 from './img/last1.png'
const Last = () => {
  return (
    <div class="blog-area-1 space position-relative">
  ...
  <a href='#' className='btn btn-primary  btn-sm  animated-buttonn victoria-one'> Read More<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
